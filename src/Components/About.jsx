        ...
        <>
            ...
            <div className="about--container fullScreen" id="ABOUT">
                ...
                <div id="about--container--wrapper">
                    ...
                    I fell in love with integrating what I've learned in projects during high school which incentivized me to major in Computer Science. I'm currently a Software Engineer with <b ><a id="social--payme" href="https://www.socialpayme.com/" target="_blank">Social Payme</a></b> but in my free time, I enjoy cooking trending food recipes with my partner. 
