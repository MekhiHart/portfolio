    ...
    return(
        ...
        <div className="hero--container fullScreen" id='HERO'>
            <div className="hero--intro">
                ...
                <h2>  Incoming SWE Intern @ <a href="https://www.netflix.com/" target='_blank' style={{color:"#e50a14", fontWeight:"bold", fontFamily:"Bebas Neue", letterSpacing:"2px", textDecoration:"none"}}>Netflix</a> </h2>
