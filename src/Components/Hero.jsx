    ...
    return(
        ...
        <div className="hero--container fullScreen" id='HERO'>
            <div className="hero--intro">
                ...
                <h2>  Incoming SWE Intern @ <span id='netflix--name' style={{color:"#e50a14", fontWeight:"bold", fontFamily:"Bebas Neue", letterSpacing:"2px", textDecoration:"none"}}>Netflix</span> </h2>
